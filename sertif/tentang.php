...
<?php include "header.php";?>
 ...
 <!--ISI KONTEN---> <h1>Tentang kami</h1>
 <div class= "contact"> Eginabus merupakan aplikasi pemesanan tiket secara online yang dirancang untuk keperluan
    masyarakat Indonesia dengan tujuan pembelian tiket bus yang lebih efisien dan efektif. </div>
